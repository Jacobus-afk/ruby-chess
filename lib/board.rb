...
class Board
  ...
  def start_game
    ...
    @board[1][0] = ChessPiece.new(1, '♟︎', 'a7')
    @board[1][1] = ChessPiece.new(1, '♟︎', 'b7')
    @board[1][2] = ChessPiece.new(1, '♟︎', 'c7')
    @board[1][3] = ChessPiece.new(1, '♟︎', 'd7')
    @board[1][4] = ChessPiece.new(1, '♟︎', 'e7')
    @board[1][5] = ChessPiece.new(1, '♟︎', 'f7')
    @board[1][6] = ChessPiece.new(1, '♟︎', 'g7')
    @board[1][7] = ChessPiece.new(1, '♟︎', 'h7')
