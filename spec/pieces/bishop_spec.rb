...
describe Bishop do
  ...
  describe '#generate_possible_moves' do
    it "bishop's first move" do
      ...
      expect(white_white_square).to contain_exactly('f1', 'g2', 'h3', 'f1', 'e2', 'd3', 'c4', 'b5', 'a6')
      expect(white_black_square).to contain_exactly('c1', 'c1', 'b2', 'a3', 'd2', 'e3', 'f4', 'g5', 'h6')
      expect(black_white_square).to contain_exactly('c8', 'c8', 'b7', 'a6', 'd7', 'e6', 'f5', 'g4', 'h3')
      expect(black_black_square).to contain_exactly('f8', 'f8', 'g7', 'h6', 'e7', 'd6', 'c5', 'b4', 'a3')
    end
    it "not bishop's first move" do
      ...
      black_white_square = extract_path_positions(bishop_black_white_square.possible_paths)
      black_black_square = extract_path_positions(bishop_black_black_square.possible_paths)
      expect(white_white_square).to contain_exactly('h3', 'h3', 'g2', 'f1', 'g4', 'f5', 'e6', 'd7', 'c8')
      expect(white_black_square).to contain_exactly('e3', 'e3', 'e3', 'e3', 'd2', 'c1', 'f2', 'g1', 'd4',
                                                    'c5', 'b6', 'a7', 'f4', 'g5', 'h6')
      expect(black_white_square).to contain_exactly('f5', 'f5', 'f5', 'f5', 'e6', 'd7', 'c8', 'g6', 'h7',
                                                    'g4', 'h3', 'e4', 'd3', 'c2', 'b1')
      expect(black_black_square).to contain_exactly('a3', 'a3', 'b2', 'c1', 'b4', 'c5', 'd6', 'e7', 'f8')
    end
  end
end
