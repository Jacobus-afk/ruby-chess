...
describe Queen do
  ...
  describe '#generate_possible_moves' do
    it "queen's first move" do
      ...
      expect(positions_white).to contain_exactly('d2', 'd3', 'd4', 'd5', 'd6', 'd7', 'd8',
                                                 'c2', 'b3', 'a4',
                                                 'e2', 'f3', 'g4', 'h5',
                                                 'a1', 'b1', 'c1', 'e1', 'f1', 'g1', 'h1')
      expect(positions_black).to contain_exactly('d7', 'd6', 'd5', 'd4', 'd3', 'd2', 'd1',
                                                 'c7', 'b6', 'a5',
                                                 'e7', 'f6', 'g5', 'h4',
    ...
    it "not queen's first move" do
      ...
      positions_white = extract_path_positions(queen_white.possible_paths)
      positions_black = extract_path_positions(queen_black.possible_paths)
      expect(positions_white).to contain_exactly('d1', 'd2', 'd3', 'd5', 'd6', 'd7', 'd8',
                                                 'a4', 'b4', 'c4', 'e4', 'f4', 'g4', 'h4',
                                                 'a1', 'b2', 'c3', 'e5', 'f6', 'g7', 'h8',
                                                 'a7', 'b6', 'c5', 'e3', 'f2', 'g1')
      expect(positions_black).to contain_exactly('a1', 'a2', 'a3', 'a4', 'a6', 'a7', 'a8',
